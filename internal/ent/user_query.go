...
func (uq *UserQuery) loadCourses(ctx context.Context, query *CourseQuery, nodes []*User, init func(*User), assign func(*User, *Course)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(course.FieldID), joinT.C(user.CoursesPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(user.CoursesPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.CoursesPrimaryKey[0]))
